...
set genomeRtd $env(RT_TMP)/33B6A460.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {muxpart__738_register_file_r_z}]"
...
set genomeName [subst -nocommands -novariables {muxpart__738_register_file_r_z}]
