...
set genomeRtd $env(RT_TMP)/7A3D26C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {register_file_r_z__GB10}]"
...
set genomeName [subst -nocommands -novariables {register_file_r_z__GB10}]
