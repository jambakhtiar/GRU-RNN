...
set genomeRtd $env(RT_TMP)/776D2360.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {register_file__parameterized0__GB2}]"
...
set genomeName [subst -nocommands -novariables {register_file__parameterized0__GB2}]
