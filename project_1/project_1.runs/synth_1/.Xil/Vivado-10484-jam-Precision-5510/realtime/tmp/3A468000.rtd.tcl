...
set genomeRtd $env(RT_TMP)/3A468000.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {muxpart__166_register_file__parameterized0}]"
...
set genomeName [subst -nocommands -novariables {muxpart__166_register_file__parameterized0}]
