...
HD_PWD='/home/jam/Downloads/GRU/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gru_cell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gru_cell.tcl
