...
set genomeRtd $env(RT_TMP)/1D5DD100.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {activation_function__GB3}]"
...
set genomeName [subst -nocommands -novariables {activation_function__GB3}]
